...
func (a *App) validateTemplates(ctx context.Context) error {
	...
	if err := requireText("Portal cloud-init", rendered,
		...
		"debugging=0.2.16|sha256:1876dca63c11974f0900136ebe1494b60475ecaa7e1fb61689adf76f77c05ea4",
		...
		"hcp-terraform=0.7.0|sha256:3f34cba5aaaaf61b36480ec3c77f55f7dae0da90a851455ddf9beeda1a3e0baa",
		...
		`release_tag="runner-v0.20.0"`,
		`release_name="emisar-0.20.0-linux-${runner_arch}"`,
