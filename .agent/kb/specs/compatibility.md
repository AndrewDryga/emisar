...
components. The current release snapshot is product `v0.36.0`, runner
`0.17.2`, and `emisar-mcp` `0.6.0`. Those component versions are release tips;
...
`runner-v0.17.2` and `mcp-v0.6.0`. The
