...
components. The current release snapshot is product `v0.40.0`, runner
`0.20.0`, and `emisar-mcp` `0.7.0`. Those component versions are release tips;
...
`runner-v0.20.0` and `mcp-v0.7.0`. The
