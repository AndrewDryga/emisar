...
components. The current release snapshot is product `v0.47.0`, runner
`0.27.0`, and `emisar-mcp` `0.14.0`. Those component versions are release tips;
...
`runner-v0.27.0` and `mcp-v0.14.0`.
