...
| Pack visibility | MCP `list_packs include=all`: selected trusted refs present, executable, no unexplained issues; an absent ref is checked on the portal's **Packs** page for its exact account trust state |
