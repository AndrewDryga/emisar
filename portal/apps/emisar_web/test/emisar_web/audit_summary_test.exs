    ...
    test "each renders its notable fact" do
      cases = [
        ...
        {"user.mfa_rate_limited",
         ...
         [{"step", "challenge"}, {"limit", "5"}, {"window", "5 minutes"}]},
        ...
        {"enrollment_key.created", %{"reusable" => false}, [{"reusable", "no"}]},
        ...
        {"api_key.created", %{"prefix" => "emk-1234", "kind" => "audit_export"},
         [{"prefix", "emk-1234"}, {"kind", "audit_export"}]},
