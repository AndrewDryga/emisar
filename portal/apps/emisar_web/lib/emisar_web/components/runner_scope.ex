defmodule EmisarWeb.RunnerScope do
  ...
  def runner_scope_select(assigns) do
    ...
    <div {@rest}>
      ...
      <div
        :if={@runners == []}
        class="rounded-xl border border-zinc-800 bg-zinc-950/40 px-3 py-4 text-xs text-zinc-500"
      >
      ...
      <div
        :if={@runners != []}
        class="max-h-72 divide-y divide-zinc-900 overflow-y-auto overscroll-contain rounded-xl border border-zinc-800 bg-zinc-950/40"
      >
