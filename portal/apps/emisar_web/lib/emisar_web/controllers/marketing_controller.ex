defmodule EmisarWeb.MarketingController do
  ...
  @pages [
    ...
    {"/docs/runbooks", :docs_runbooks, :docs_runbooks,
     "Runbooks — typed, staged infrastructure automation",
     "Author versioned runbooks with typed inputs, stage barriers, bounded fan-out, exact pack resolution, approvals, output checks, waits, and durable results shared by operators and LLMs."},
