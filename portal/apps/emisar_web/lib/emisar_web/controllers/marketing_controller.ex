defmodule EmisarWeb.MarketingController do
  ...
  @pages [
    ...
    {"/docs/mcp-reference", :docs_mcp_reference, :docs_mcp_reference,
     ...
     "The emisar MCP API reference for builders: thirteen fixed discovery, action, operation, history, wait, and runbook tools; immutable pack and runner references; atomic mutation recovery; cancellation; signing; and actionable errors."},
    ...
    {"/docs/connect-a-cli-client", :connect_cli_client, :connect_cli_client,
     "Connect a CLI agent",
     "Connect Claude Code, Cursor, Claude Desktop, and a dozen CLI and IDE AI agents to emisar with the emisar-mcp stdio bridge or a raw emk- API key over plain HTTP."},
