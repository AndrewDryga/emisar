defmodule EmisarWeb.MarketingController do
  ...
  @pages [
    ...
    {"/docs/runner-fleet", :docs_runner_fleet, :docs_runner_fleet, "Manage the runner fleet",
     "Manage runner groups, labels, enrollment keys, pack credentials, connectivity, updates, and removal."},
    {"/docs/production", :docs_production, :docs_production, "Go to production",
    ...
    {"/docs/runner-upgrades", :docs_runner_upgrades, :docs_runner_upgrades, "Upgrade runners",
     "Upgrade runners through a canary, verify each batch, and keep a supported rollback version."},
    {"/docs/runner-credentials", :docs_runner_credentials, :docs_runner_credentials,
     "Runner credentials",
