defmodule EmisarWeb.MarketingController do
  ...
  @pages [
    ...
    {"/trust", :trust, :trust, "Security, compliance & trust",
     "Review emisar's current security controls: private Google Cloud infrastructure, least-privilege access, recovery controls, hardened CI/CD with SBOM and provenance, durable audit, subprocessors, insurance, and our honest SOC 2 Type II status."},
