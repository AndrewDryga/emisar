defmodule EmisarWeb.MarketingController do
  ...
  @pages [
    ...
    {"/docs/sso/okta", :docs_sso_okta, :docs_sso_okta, "Okta SSO & SCIM setup",
    ...
    {"/docs/sso/entra", :docs_sso_entra, :docs_sso_entra, "Microsoft Entra SSO & SCIM setup",
    ...
    {"/docs/sso/jumpcloud", :docs_sso_jumpcloud, :docs_sso_jumpcloud,
    ...
    {"/docs/sso/keycloak", :docs_sso_keycloak, :docs_sso_keycloak, "Keycloak SSO setup",
    ...
    {"/docs/sso/google-workspace", :docs_sso_google_workspace, :docs_sso_google_workspace,
