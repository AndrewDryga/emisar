defmodule EmisarWeb.MarketingController do
  ...
  @pages [
    ...
    {"/support", :support, :support, "Support",
     "Find documentation, Team email support, Enterprise Slack support, and help with billing, account access, or security reports."},
    ...
    {"/docs/connect-coop", :connect_coop, :connect_coop, "Connect co:op",
     "Use co:op to run AI agents in a local sandbox, and emisar to control what they can do with your infrastructure."},
    {"/docs/connect-docker-sandboxes", :connect_docker_sandboxes, :connect_docker_sandboxes,
     "Connect Docker Sandboxes",
     "Run an AI coding agent in a Docker microVM and connect emisar through Docker's host-side MCP gateway."},
    {"/docs/connect-nono", :connect_nono, :connect_nono, "Connect nono",
     "Run a local CLI agent under nono's operating-system sandbox and connect it to emisar."},
    {"/docs/connect-dev-containers", :connect_dev_containers, :connect_dev_containers,
     "Connect a Dev Container",
     "Run a CLI agent and the emisar MCP bridge inside a restricted development container."},
