defmodule EmisarWeb.MarketingController do
  ...
  @pages [
    ...
    {"/docs/integrations/jumpcloud", :docs_sso_jumpcloud, :docs_sso_jumpcloud,
     ...
     "Connect JumpCloud to emisar step by step, with screenshots: one custom application carrying OIDC sign-in and directory provisioning together, certified against a live tenant."},
    {"/docs/integrations/keycloak", :docs_sso_keycloak, :docs_sso_keycloak, "Keycloak SSO setup",
     "Connect Keycloak to emisar step by step, with screenshots: a confidential OpenID Connect client with PKCE, verified end to end — and what Keycloak's missing outbound SCIM leaves you to do."},
