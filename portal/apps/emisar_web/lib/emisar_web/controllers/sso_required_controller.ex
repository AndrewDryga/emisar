defmodule EmisarWeb.SSORequiredController do
  ...
  bounces a non-SSO session here when the account mandates single sign-on; this logs
  the session out (a LiveView on_mount can't clear the plug session) and lands the
