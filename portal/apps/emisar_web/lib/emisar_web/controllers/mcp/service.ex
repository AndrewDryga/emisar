defmodule EmisarWeb.MCP.Service do
  ...
  defp fixed_review(review) do
    %{
      ...
      reason_truncated: if(review.reason_truncated, do: true),
      evidence: review.evidence,
      evidence_truncated: if(review.evidence_truncated, do: true),
      expected: review.expected,
      expected_truncated: if(review.expected_truncated, do: true),
