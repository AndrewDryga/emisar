defmodule EmisarWeb.Plugs.Analytics do
  ...
  first-touch traffic attribution rides the existing encrypted session; the
  anonymous id remains a cookieless weekly hash (see `EmisarWeb.Analytics`). No-op for
