  ...
  describe "Emisar.Checks.WebNoNestedDomainCalls" do
    ...
    test "allows the Emisar.Auth.Subject carrier, aliased or fully qualified" do
      ...
      defmodule EmisarWeb.Probe do
        ...
        def build(member, account), do: Subject.for_member(member, account, :magic_link, [])
        def rebuild(member, account), do: Emisar.Auth.Subject.for_member(member, account, nil)
      end
      """
