defmodule Emisar.Accounts.Account.Changeset do
  ...
  # the context's field-aware permission check (Accounts.update_account/3)
  # decides who may change which field. Plan is NOT settable here — it's
  # derived from the account's subscription (`Billing.account_plan/1`).
