...
- **Content:** [public claims follow owned contracts](.agent/kb/rules/content-public-claims-follow-owned-contracts.md) — derive public counts and plan features from their owning implementation; name related security evidence layers separately and state only what each one proves.
