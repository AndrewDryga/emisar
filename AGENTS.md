...
- **Content:** [marketing headlines are flat statements](.agent/rules/content-flat-headlines.md) — every headline is a category claim, benefit statement, or concrete inventory (the tailscale.com register); no aphorisms, comma-flourishes, riddles, wordplay, or fragment drumbeats.
