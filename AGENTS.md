...
- **Shared:** [repository knowledge lives in the KB](.agent/kb/rules/shared-repository-knowledge-lives-in-kb.md) — the website owns product documentation; repository cards, specifications, runbooks, and rules live under `.agent/kb/`, while published integration files stay with their artifact.
